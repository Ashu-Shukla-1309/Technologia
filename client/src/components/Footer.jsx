      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><Link to="/profile" className="hover:text-blue-600 transition">About Technologia</Link></li>
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a 
                ...
                className="bg-gray-100 p-3 rounded-full hover:bg-blue-600 hover:text-white text-gray-600 transition-all"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="bg-gray-100 p-3 rounded-full hover:bg-gray-900 hover:text-white text-gray-600 transition-all"
              >
